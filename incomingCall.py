...
def location():
    ...
    if 'SpeechResult' in request.values:
        ...
        #---Check Correctness---#
        isCorrect = confirm("summry", sumLong)
        if isCorrect == true:
            print(name) #Check
            gatherSummary = Gather(input = 'speech dtmf', action='/location')
            gatherSummary.say("Hi " + name + "Thanks, Can you tell me the location of the meeting?")
            resp.append(gatherSummary)
            return str(resp)
        #---Check Correctness---#
        print(sumLong)
...
def startTime():
    ...
    if 'SpeechResult' in request.values:
        ...
        #---Check Correctness---#
        isCorrect = confirm("locationDet", name)
        if isCorrect == true:
            print(locationDet) #check
...
def endTime():
    ...
    if 'SpeechResult' in request.values:
        ...
        isCorrect = confirm("startTimeDet", name)
        if isCorrect == true:
            print(startTimeDet)#Check
...
def bookMeeting():
    ...
    if 'SpeechResult' in request.values:
        ...
        isCorrect = confirm("endTimeDet", name)
        if isCorrect == true:
            pprint(endTimeDet)
